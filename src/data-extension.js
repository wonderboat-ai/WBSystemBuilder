...
{id:'gar-gra-10', sku:'010-11324-00', family:'GRA', model:'GRA 10 Rudder Angle Adapter', category:'Sensor',
 ...
 ports:[{type:'N2K-Micro',qty:1}], _verify:true, n2kLen:1},
{id:'gar-dst-800', sku:'010-11051-00', family:'Airmar', model:'DST 800 Smart Triducer (Wired) (DESCONTINUADO US)', category:'Sensor',
 description:'Airmar passante velocidade/temp/profundidade NMEA 2000 wired. Descontinuado no site Garmin US (pagina retorna 404/500) — substituto atual e o DST 810 (gar-dst-810), que adiciona sensor de atitude e compensacao de deadrise. Mantido no catalogo so pra projetos que ja usam esse SKU.',
 ports:[{type:'N2K-Micro',qty:1}], _verify:true, n2kLen:1},
