...
{id:'gar-echomap-uhd2-93sv',sku:'010-02692-01',family:'ECHOMAP UHD2',model:'ECHOMAP UHD2 93sv',category:'MFD',
 ...
 power:{voltage:'12VDC'},ports:[{type:'N2K-Micro',qty:1},{type:'NMEA0183',qty:1},{type:'WiFi',qty:1},{type:'SonarConn',qty:1},{type:'Power-12',qty:1}],_verify:true},
{id:'gar-echomap-ultra2-106sv',sku:'010-02893-00',family:'ECHOMAP Ultra 2',model:'ECHOMAP Ultra 2 106sv',category:'MFD',
 description:'MFD 10" SideVü/ClearVü/Panoptix-ready.',
 power:{voltage:'12VDC'},ports:[{type:'N2K-Micro',qty:1},{type:'NMEA0183',qty:1},{type:'WiFi',qty:1},{type:'SonarConn',qty:1},{type:'Power-12',qty:1}],_verify:true},
{id:'gar-echomap-ultra2-126sv',sku:'010-02893-01',family:'ECHOMAP Ultra 2',model:'ECHOMAP Ultra 2 126sv',category:'MFD',
...
{id:'gar-lvs34',sku:'010-12516-00',family:'Panoptix LiveScope+',model:'LVS34 Transducer',category:'Sonar',
 ...
 power:{voltage:'-'},ports:[{type:'SonarConn',qty:1}],_verify:true},
{id:'gar-lvs62',sku:'010-13128-00',family:'Panoptix LiveScope XR',model:'LVS62 Transducer',category:'Sonar',
...
{id:'gar-reactor40-mech',sku:'010-00705-89',family:'Reactor 40',model:'Reactor 40 Mechanical Corepack',category:'Autopilot',
 ...
 power:{voltage:'12VDC'},ports:[{type:'N2K-Micro',qty:1},{type:'Power-12',qty:1}],_verify:true},
{id:'gar-reactor40-compact',sku:'010-02502-00',family:'Reactor 40',model:'Reactor 40 Compact',category:'Autopilot',
 description:'Compact Reactor 40 — barcos pequenos com leme hidráulico.',
 power:{voltage:'12VDC'},ports:[{type:'N2K-Micro',qty:1},{type:'Power-12',qty:1}],_verify:true},
{id:'gar-reactor40-kicker',sku:'010-01827-00',family:'Reactor 40',model:'Reactor 40 Kicker',category:'Autopilot',
...
{id:'gar-force-kraken-48',sku:'010-02835-00',family:'Force Kraken',model:'Force Kraken 48" Black',category:'TrollingMotor',
...
{id:'gar-force-kraken-63',sku:'010-02835-10',family:'Force Kraken',model:'Force Kraken 63"',category:'TrollingMotor',
 description:'Trolling motor Kraken 63".',
 power:{voltage:'24-36VDC'},ports:[{type:'N2K-Micro',qty:1},{type:'Power-24',qty:1}],_verify:true},
{id:'gar-force-kraken-75',sku:'010-02835-20',family:'Force Kraken',model:'Force Kraken 75"',category:'TrollingMotor',
...
{id:'gar-vhf-215-ais',sku:'010-01959-01',family:'VHF',model:'VHF 215 AIS',category:'VHF',
 ...
 power:{voltage:'12VDC'},ports:[{type:'N2K-Micro',qty:1},{type:'NMEA0183',qty:1},{type:'VHFAntenna',qty:1},{type:'Power-12',qty:1}],_verify:true},
{id:'gar-vhf-315',sku:'010-01958-00',family:'VHF',model:'VHF 315',category:'VHF',
...
{id:'gar-gtb-10',sku:'010-12082-00',family:'OnDeck',model:'GTB 10 OnDeck Hub',category:'Network',
...
{id:'gar-gps-24xd',sku:'010-02315-00',family:'GPS Antenna',model:'GPS 24xd Receiver',category:'Antenna',
 ...
 power:{voltage:'12VDC'},ports:[{type:'N2K-Micro',qty:1}],_verify:true},
{id:'gar-gps-24xd-hvs',sku:'010-02315-10',family:'GPS Antenna',model:'GPS 24xd HVS (heading)',category:'Antenna',
...
{id:'gar-gsv-10',sku:'010-12005-00',family:'GSV',model:'GSV 10 Surround View',category:'Camera',
...
{id:'gar-gst-43',sku:'010-01802-21',family:'GST',model:'GST 43 Speed/Temp Thru-Hull 43mm',category:'Sensor',
 description:'Transdutor velocidade/temperatura passante 43mm — substitui Nexus TH43.',
 ports:[{type:'N2K-Micro',qty:1}],_verify:true},
{id:'gar-gdt-43',sku:'010-01802-22',family:'GDT',model:'GDT 43 Depth Thru-Hull 43mm',category:'Sensor',
 description:'Transdutor de profundidade 43mm — adapta a NMEA 2000.',
 ports:[{type:'N2K-Micro',qty:1}],_verify:true},
{id:'gar-dst-810',sku:'010-12646-00',family:'Airmar',model:'DST 810 Smart Triducer',category:'Sensor',
...
const ADAPTERS = [
/* N2K core */
{id:'adp-n2k-term-m',sku:'010-11521-10',brand:'Garmin',family:'N2K',model:'Terminador N2K Macho 120Ω',category:'Adapter',description:'Terminador macho 120Ω.',ports:[{type:'N2K-Micro',qty:1}],_verify:true},
{id:'adp-n2k-term-f',sku:'010-11521-00',brand:'Garmin',family:'N2K',model:'Terminador N2K Fêmea 120Ω',category:'Adapter',description:'Terminador fêmea 120Ω.',ports:[{type:'N2K-Micro',qty:1}],_verify:true},
...
/* BlueNet cables */
{id:'cab-bn-2m',sku:'010-13500-00',brand:'Garmin',family:'BlueNet',model:'Cabo BlueNet 2m (6ft)',category:'Cable',description:'Cabo BlueNet — 2m.',ports:[{type:'BlueNet',qty:2}],length:2,_verify:true},
{id:'cab-bn-6m',sku:'010-13500-01',brand:'Garmin',family:'BlueNet',model:'Cabo BlueNet 6m',category:'Cable',description:'Cabo BlueNet — 6m.',ports:[{type:'BlueNet',qty:2}],length:6,_verify:true},
{id:'cab-bn-15m',sku:'010-13500-02',brand:'Garmin',family:'BlueNet',model:'Cabo BlueNet 15m',category:'Cable',description:'Cabo BlueNet — 15m.',ports:[{type:'BlueNet',qty:2}],length:15,_verify:true},
