...
- Toggle Foto oficial Garmin / Silhueta Wonder BOAT nos cards (166/175 SKUs com foto real, 95% cobertura)
...
6. **Completar os 9 SKUs sem foto** (ver `scripts/photo_failures.json`) — lista final após a revisão de conflitos de 2026-07-24, inclui `gar-fantom-126` (perdeu a foto errada que pertencia ao 124) e `adp-ydem-01` (SKU trocado pra `YDEG-04N`).
