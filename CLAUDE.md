...
- Catálogo Garmin Marine (147 devices + 20 adapters/cabos = 167 SKUs, cobrindo MFD/Radar/Sonar/Autopilot/VHF/AIS/Network/Sensors/Audio/TrollingMotor/Camera/Antenna), auditado item a item contra garmin.com/en-US em 2026-08-18
...
- Toggle Foto oficial Garmin / Silhueta Wonder BOAT nos cards (167/167 SKUs com foto real, 100% cobertura)
...
6. **Revisar os 18 itens pendentes da auditoria de 2026-08-18** (ver `scripts/audit_2026-08-18_pending_review.json`, já reduzido de 53 pra 18 após 2 rodadas extras de correção/pesquisa) — o que sobrou são principalmente portas menores em famílias MFD (Fusion, GPSMAP 1223, GTB 10 etc.), itens de fabricante terceiro fora do escopo garmin.com (Actisense/Maretron/Yacht Devices), e 2 questões de modelagem de kit (GNX Sail Pack) que dependem de decisão do Lucas sobre arquitetura do catálogo (item único vs. múltiplos nós).
